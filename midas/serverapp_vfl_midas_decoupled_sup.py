# serverapp_vfl_midas_decoupled_sup.py
# Flower 1.26.1 compatible — uses ServerApp() + @app.main()
#
# Hybrid SS-VFL: Active silo uses supervised pretrained encoder (dscope).
...
def main(grid: Grid, context: Context) -> None:
    ...
    out_dir = Path(os.environ.get("OUT_DIR", "runs_midas_dvfl_sup"))
