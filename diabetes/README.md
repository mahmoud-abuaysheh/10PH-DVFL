...
```bash
python make_iid_partitions.py --npz diabetes_vfl_cv.npz --Ks 10 20 --out_dir partitions_iid
```

This generates JSON partition files in `partitions_iid/` for K=10 and K=20. Only IID partitioning was used in the paper.
...
serverapp = "serverapp_vfl_diabetes_splitnn:app"
clientapp = "clientapp_vfl_diabetes_splitnn:app"
```
