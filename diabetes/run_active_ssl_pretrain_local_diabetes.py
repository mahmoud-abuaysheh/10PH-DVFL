...
# SSL (denoising autoencoder) pretrain for ACTIVE silo (X1) on Diabetes npz.
...
def main():
    ...
    ap.add_argument("--out-dir", default="runs_active_ssl_diabetes")
    args = ap.parse_args()
    ...
    for ep in range(1, args.epochs + 1):
        ...
        print(f"[Active SSL] fold={args.fold} epoch={ep}/{args.epochs} avg_mse={loss_sum/max(n,1):.6f}")
