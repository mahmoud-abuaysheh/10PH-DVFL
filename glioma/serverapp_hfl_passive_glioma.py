...
# Flower 1.26.1 — True federated HFL for passive silo pretraining (Glioma).
# Direct adaptation of serverapp_hfl_passive_diabetes.py.
#
# Architecture differences vs DIA:
#   BottomMLP:  in_dim -> 32 -> 16  (DIA: in_dim -> 16 -> 8)
#   ReconHead:  16 -> 32 -> in_dim  (DIA: 8 -> 16 -> in_dim)
#   out_dim = 16                    (DIA: 8)
#   tag uses "bottom32_out16"       (DIA: "bottom16_out8")
#
# Checkpoint saved as:
...
def main(grid: Grid, context: Context) -> None:
    # ── Hyperparams — env var takes priority, then run_config, then default ───
    ...
    out_dir = Path(os.environ.get("OUT_DIR", rc.get("out_dir", "runs_passive_hfl_glioma_flower")))
    ...
    # ── Step 1: Query each client for partition size and in_dim ───────────────
