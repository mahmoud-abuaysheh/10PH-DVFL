# run_active_ssl_pretrain_local_glioma.py
#
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Self-supervised DAE pre-training for the glioma active-silo encoder (X1)."
    )
    ...
    ap.add_argument("--out-dir",    default="runs_active_ssl_glioma",
    ...
    bottom = BottomMLP(
        in_dim=X1.shape[1], out_dim=args.out_dim, dropout=args.dropout
    ).to(dev)
