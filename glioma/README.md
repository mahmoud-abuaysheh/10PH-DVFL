...
**Condition 4 — HFL passive pre-training:**

Run with K=10 and K=20 using the dedicated federation names. The npz path must be provided as an absolute path:
...
Replace `/path/to/` with the absolute path to the file on your machine.
